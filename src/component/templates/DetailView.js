...
import { Backdrop, Container, SpeedDial, SpeedDialAction, SpeedDialIcon, Stack, Typography, useMediaQuery } from "@mui/material";
...
export default function DetailView(props) {
  ...
  const actions = speedDialActions ? speedDialActions : [
    {
      name: "Create Donasi",
      icon: <Add />,
