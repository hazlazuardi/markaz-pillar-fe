    ...
    const handleOAuth = async (event) => {
        ...
        await axiosMain
            ...
            .then(response => {
                ...
                router.replace(`https://accounts.google.com/o/oauth2/v2/auth/oauthchooseaccount?NEXT_PUBLIC_REDIRECT_URI=${frontendURL}oauth/google/callback&prompt=consent&response_type=code&client_id=620820262877-85f9anugmu77f59ibtu3qfbf2nmat00j.apps.googleusercontent.com&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fuserinfo.email%20https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fuserinfo.profile%20openid&access_type=offline&flowName=GeneralOAuthFlow&state=${response.data.result.state}`)
            })
    }
    return (
        <>
