DROP TABLE `kelas_list_dummy`;

CREATE TABLE `kelas_list_dummy` (
  `id` mediumint(8) unsigned NOT NULL auto_increment,
  `kelas_name` varchar(255) default NULL,
  `ktp` varchar(13) default NULL,
  `kelas_email` varchar(255) default NULL,
  `status` varchar(255),
  PRIMARY KEY (`id`)
) AUTO_INCREMENT=1;

INSERT INTO `kelas_list_dummy` (`kelas_name`,`ktp`,`kelas_email`,`status`) 
VALUES 
